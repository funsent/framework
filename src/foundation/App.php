...
class App extends Container
{
    ...
    {
        return dirname($this->frameworkPath, 2) . DIRECTORY_SEPARATOR;
    }
    ...
    public function initialize()
    {
        ...
        $this->beginTime = START_TIME ?? microtime(true);
        $this->beginMem  = START_MEMORY ?? memory_get_usage();
        ...
        $this->lang->load($this->frameworkPath . 'lang' . DIRECTORY_SEPARATOR . $langSet . '.php');
