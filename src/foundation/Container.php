...
use funsent\exception\ClassNotFoundException;
use funsent\exception\FunctionNotFoundException;
...
class Container implements ContainerInterface, ArrayAccess, IteratorAggregate, Countable
{
    ...
    public function invokeMethod($method, array $vars = [], bool $accessible = false)
    {
        ...
        try {
            ...
            throw new FunctionNotFoundException('method not exists: ' . $class . '::' . $method . '()', "{$class}::{$method}", $e);
        }
