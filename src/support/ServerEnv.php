...
class ServerEnv
{
    ...
    // 确定shell位置
    public function find_command($cName)
    {
    ...
    // 格试化内存显示单位
    protected function formatmem($mem)
    {
        ...
        <div class="con">
            ...
            <div class="j_tb"><label class="j_td j_td_t">硬盘使用状况</label>
                <label>总空间 <?= $S->hd['t']; ?>&nbsp;G，已用 <font color='#333333'><span id="useSpace"><?= $S->hd['u']; ?></span></font>&nbsp;G，
                    ...
                    <div class="bar">
                        <div id="barhdPercent" class="barli_black" style="width:<?= $S->hd['PCT'] ?>%">&nbsp;</div>
                    </div>
                </label>
            </div>
            <div class="j_tb"><label class="j_td j_td_t">内存使用状况</label>
                <label class="j_td">物理内存：共<font color='#CC0000'><?= $S->sysInfo['memTotal']; ?> </font>
                    ...
                    <div class="bar">
                        <div id="barmemPercent" class="barli_red" style="width:<?= $S->sysInfo['memPercent']; ?>%">&nbsp;</div>
                    </div>
                    <?php if ($S->sysInfo['memCached']) { ?>
                        ...
                        <div class="bar">
                            <div id="barmemCachedPercent" class="barli_blue" style="width:<?= $S->sysInfo['memCachedPercent']; ?>%">&nbsp;</div>
                        </div>
                        ...
                        <div class="bar_1">
                            <div id="barmemRealPercent" class="barli_1" style="width:<?= $S->sysInfo['memRealPercent']; ?>%">&nbsp;</div>
                        </div>
                    <?php } ?>
                    <?php if ($S->sysInfo['swapTotal']) { ?>
                        ...
                        <div class="bar">
                            <div id="barswapPercent" class="barli_red" style="width:<?= $S->sysInfo['swapPercent']; ?>%">&nbsp;</div>
                        </div>
                    <?php } ?>
                </label>
            </div>
